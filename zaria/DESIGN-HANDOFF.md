# 396f571b-9ecc-440e-94e3-002272523e48 implementation handoff

This archive is the source of truth for turning the design into production code. Start from `about.html`, then preserve the visual system, responsive behavior, and interactions found in the exported files.
...
- A single self-contained `about.html` is acceptable only when the export truly contains one user-facing screen and its CSS/JS are structured enough to extract tokens, components, states, and behavior.
...
1. Open `about.html` and `DESIGN-MANIFEST.json`; identify every screen file, launcher/overview file, app module, and interaction before coding.
...
- `brand-spec.md`
- `mqjfnhjv-image.png`
- `mqjhfeq2-drawing-2026-06-18T12-34-40-480Z.png`

## Coding checklist for AI tools
1. Inspect `about.html` and `DESIGN-MANIFEST.json` first and identify reusable components before coding.
